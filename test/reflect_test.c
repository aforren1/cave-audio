 ...
 * ones. This exercises the full bwaudio path (phonon ambisonic convolution -> custom 26-speaker
...
int main(void) {
    ...
    SteamReflect* refl = steam_reflect_create(scene, rt, &L, SR, BLK, /*order*/1, /*ir*/0.5f, /*rays*/4096, /*bounces*/16);
