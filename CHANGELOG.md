...
https://github.com/aforren1/cave-audio/blob/3c1f0fcc3de4/docs/api.md → "Coordinates and units".
...
- **The release artifacts no longer ship dangling doc pointers.** The 0.4.0 zip contained
  `playground.gd` and `scenes.gd` citing `https://github.com/aforren1/cave-audio/blob/3c1f0fcc3de4/docs/api.md` and `THIRD_PARTY-NOTICES.md` citing
  `https://github.com/aforren1/cave-audio/blob/3c1f0fcc3de4/docs/build.md`, none of which are in the zip. Both packs now run `tools/dist/doc-pointers.ps1`,
...
- **Docs**: the README and `https://github.com/aforren1/cave-audio/blob/3c1f0fcc3de4/docs/integration.md` "1:1" claims now name the two deliberately-unbound
