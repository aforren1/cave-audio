...
#include "acoustics/steam_scene.h"   /* SteamScene* (opaque) + the phonon-object accessors */
#include "core/rt.h"            /* RtCore* (for the listener pose) + the RtBusTap signature */
#include "core/layout.h"        /* Layout — the 26 speaker directions for the custom-layout decode */
#include <stdint.h>
