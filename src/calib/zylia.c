...
#include "cJSON.h"
#include "spatial/ambisonics.h"   /* the engine's own xval-pinned ACN/SN3D basis, for the intensity DOA */
#include "dsp/fft.h"          /* offline analysis FFT (header-only); NOT for the audio thread */
