 ...
 */
#include "core/rt.h"
#include "tracking/pose.h"     /* the seqlock: the tracker slot the mixer samples + the readback slot */
...
#include "spatial/cap.h"          /* compensated amplitude panning: the dual-band low band's ITD correction */
#include "spatial/hole.h"         /* hole-aware spread floor: array holes widen a source instead of splitting it */
#include "spatial/align.h"
#include "acoustics/ism.h"          /* image-source early reflections (shoebox geometry; phonon-free) */
#include "dsp/biquad.h"       /* shared RBJ cookbook (also used by align.c's room_eq) */
#include "spatial/ambisonics.h"   /* SH->26 decode for ambisonic beds (+ room_to_ambi, ambi_sad_decode) */
#include "spatial/allrad.h"       /* robust SH->26 decode for irregular arrays */
#include "spatial/epad.h"         /* energy-preserving SH->26 decode (bed_decoder = 2) */
#include "core/bits.h"         /* bwa_pow2_ge */
#include "core/sane.h"         /* bwa_quat_unit, bwa_finite3_bounded, bwa_finite_clamp */
#include "core/profile.h"      /* Tracy zones/plots (no-ops unless BWA_TRACY=ON) */
